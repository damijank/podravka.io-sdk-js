...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Podravkaio.VideoCreateRead = factory(root.Podravkaio.ApiClient, root.Podravkaio.UserEmbed);
  }
  ...
  /**
   * The VideoCreateRead model module.
   * @module model/VideoCreateRead
   * @version 0.2.0
   */

  /**
   * Constructs a new <code>VideoCreateRead</code>.
   * Video.
   * @alias module:model/VideoCreateRead
   * @class
   * @param name {String} 
   */
  ...
  /**
   * Constructs a <code>VideoCreateRead</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/VideoCreateRead} obj Optional instance to populate.
   * @return {module:model/VideoCreateRead} The populated <code>VideoCreateRead</code> instance.
   */
