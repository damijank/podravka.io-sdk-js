...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Podravkaio.BrandCreate = factory(root.Podravkaio.ApiClient);
  }
  ...
  /**
   * The BrandCreate model module.
   * @module model/BrandCreate
   * @version 0.2.0
   */

  /**
   * Constructs a new <code>BrandCreate</code>.
   * Brand.
   * @alias module:model/BrandCreate
   * @class
   * @param name {String} 
   */
  ...
  /**
   * Constructs a <code>BrandCreate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BrandCreate} obj Optional instance to populate.
   * @return {module:model/BrandCreate} The populated <code>BrandCreate</code> instance.
   */
