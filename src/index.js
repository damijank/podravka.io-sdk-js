...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ArticleCreate', 'model/ArticleList', 'model/ArticleOriginCreate', 'model/ArticleRead', 'model/ArticleState', 'model/ArticleUpdate', 'model/AttributeDefinitionCreate', 'model/AttributeDefinitionList', 'model/AttributeDefinitionRead', 'model/BrandCreate', 'model/BrandList', 'model/BrandRead', 'model/BrandState', 'model/BrandUpdate', 'model/ContentTaxonCreate', 'model/ContentTaxonList', 'model/ContentTaxonRead', 'model/FileCreate', 'model/FileCreateRead', 'model/FileList', 'model/FileOriginCreate', 'model/FileRead', 'model/FileState', 'model/FileUpdate', 'model/FileUpdateRead', 'model/ImageCreate', 'model/ImageCreateRead', 'model/ImageEmbed', 'model/ImageInstanceEmbed', 'model/ImageList', 'model/ImageOriginCreate', 'model/ImageRead', 'model/ImageState', 'model/ImageUpdate', 'model/ImageUpdateRead', 'model/ImageVariationEmbed', 'model/ImageVariationUrlVarsEmbed', 'model/IngredientCreate', 'model/IngredientList', 'model/IngredientOriginCreate', 'model/IngredientRead', 'model/IngredientState', 'model/IngredientUpdate', 'model/Metrics', 'model/MetricsCreate', 'model/NutritionDeclarationCreate', 'model/NutritionDeclarationEmbed', 'model/NutritionDeclarationEmbedBase', 'model/NutritionDeclarationEmbedNutrients', 'model/ProductCreate', 'model/ProductList', 'model/ProductOriginCreate', 'model/ProductRead', 'model/ProductState', 'model/ProductUpdate', 'model/RecipeCreate', 'model/RecipeIngredientCreate', 'model/RecipeIngredientEmbed', 'model/RecipeList', 'model/RecipeOriginCreate', 'model/RecipePreparationStepCreate', 'model/RecipePreparationStepEmbed', 'model/RecipeRead', 'model/RecipeState', 'model/RecipeUpdate', 'model/TaxonBagCreate', 'model/TaxonBagList', 'model/TaxonBagRead', 'model/TaxonBagUpdate', 'model/TaxonCreate', 'model/TaxonList', 'model/TaxonRead', 'model/TaxonUpdate', 'model/TaxonomyCreate', 'model/TaxonomyList', 'model/TaxonomyRead', 'model/TaxonomyUpdate', 'model/User', 'model/UserEmbed', 'model/UserGroup', 'model/UserGroupCreate', 'model/UserGroupList', 'model/UserGroupRead', 'model/UserGroupUpdate', 'model/UserList', 'model/UserRead', 'model/UserUpdate', 'model/VideoCreate', 'model/VideoCreateRead', 'model/VideoEmbed', 'model/VideoList', 'model/VideoOriginCreate', 'model/VideoRead', 'model/VideoState', 'model/VideoUpdate', 'model/VideoUpdateRead', 'api/ArticleApi', 'api/AttributeDefinitionApi', 'api/BrandApi', 'api/FileApi', 'api/ImageApi', 'api/IngredientApi', 'api/ProductApi', 'api/RecipeApi', 'api/TaxonomyApi', 'api/UserApi', 'api/VideoApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/ArticleCreate'), require('./model/ArticleList'), require('./model/ArticleOriginCreate'), require('./model/ArticleRead'), require('./model/ArticleState'), require('./model/ArticleUpdate'), require('./model/AttributeDefinitionCreate'), require('./model/AttributeDefinitionList'), require('./model/AttributeDefinitionRead'), require('./model/BrandCreate'), require('./model/BrandList'), require('./model/BrandRead'), require('./model/BrandState'), require('./model/BrandUpdate'), require('./model/ContentTaxonCreate'), require('./model/ContentTaxonList'), require('./model/ContentTaxonRead'), require('./model/FileCreate'), require('./model/FileCreateRead'), require('./model/FileList'), require('./model/FileOriginCreate'), require('./model/FileRead'), require('./model/FileState'), require('./model/FileUpdate'), require('./model/FileUpdateRead'), require('./model/ImageCreate'), require('./model/ImageCreateRead'), require('./model/ImageEmbed'), require('./model/ImageInstanceEmbed'), require('./model/ImageList'), require('./model/ImageOriginCreate'), require('./model/ImageRead'), require('./model/ImageState'), require('./model/ImageUpdate'), require('./model/ImageUpdateRead'), require('./model/ImageVariationEmbed'), require('./model/ImageVariationUrlVarsEmbed'), require('./model/IngredientCreate'), require('./model/IngredientList'), require('./model/IngredientOriginCreate'), require('./model/IngredientRead'), require('./model/IngredientState'), require('./model/IngredientUpdate'), require('./model/Metrics'), require('./model/MetricsCreate'), require('./model/NutritionDeclarationCreate'), require('./model/NutritionDeclarationEmbed'), require('./model/NutritionDeclarationEmbedBase'), require('./model/NutritionDeclarationEmbedNutrients'), require('./model/ProductCreate'), require('./model/ProductList'), require('./model/ProductOriginCreate'), require('./model/ProductRead'), require('./model/ProductState'), require('./model/ProductUpdate'), require('./model/RecipeCreate'), require('./model/RecipeIngredientCreate'), require('./model/RecipeIngredientEmbed'), require('./model/RecipeList'), require('./model/RecipeOriginCreate'), require('./model/RecipePreparationStepCreate'), require('./model/RecipePreparationStepEmbed'), require('./model/RecipeRead'), require('./model/RecipeState'), require('./model/RecipeUpdate'), require('./model/TaxonBagCreate'), require('./model/TaxonBagList'), require('./model/TaxonBagRead'), require('./model/TaxonBagUpdate'), require('./model/TaxonCreate'), require('./model/TaxonList'), require('./model/TaxonRead'), require('./model/TaxonUpdate'), require('./model/TaxonomyCreate'), require('./model/TaxonomyList'), require('./model/TaxonomyRead'), require('./model/TaxonomyUpdate'), require('./model/User'), require('./model/UserEmbed'), require('./model/UserGroup'), require('./model/UserGroupCreate'), require('./model/UserGroupList'), require('./model/UserGroupRead'), require('./model/UserGroupUpdate'), require('./model/UserList'), require('./model/UserRead'), require('./model/UserUpdate'), require('./model/VideoCreate'), require('./model/VideoCreateRead'), require('./model/VideoEmbed'), require('./model/VideoList'), require('./model/VideoOriginCreate'), require('./model/VideoRead'), require('./model/VideoState'), require('./model/VideoUpdate'), require('./model/VideoUpdateRead'), require('./api/ArticleApi'), require('./api/AttributeDefinitionApi'), require('./api/BrandApi'), require('./api/FileApi'), require('./api/ImageApi'), require('./api/IngredientApi'), require('./api/ProductApi'), require('./api/RecipeApi'), require('./api/TaxonomyApi'), require('./api/UserApi'), require('./api/VideoApi'));
  }
}(function(ApiClient, ArticleCreate, ArticleList, ArticleOriginCreate, ArticleRead, ArticleState, ArticleUpdate, AttributeDefinitionCreate, AttributeDefinitionList, AttributeDefinitionRead, BrandCreate, BrandList, BrandRead, BrandState, BrandUpdate, ContentTaxonCreate, ContentTaxonList, ContentTaxonRead, FileCreate, FileCreateRead, FileList, FileOriginCreate, FileRead, FileState, FileUpdate, FileUpdateRead, ImageCreate, ImageCreateRead, ImageEmbed, ImageInstanceEmbed, ImageList, ImageOriginCreate, ImageRead, ImageState, ImageUpdate, ImageUpdateRead, ImageVariationEmbed, ImageVariationUrlVarsEmbed, IngredientCreate, IngredientList, IngredientOriginCreate, IngredientRead, IngredientState, IngredientUpdate, Metrics, MetricsCreate, NutritionDeclarationCreate, NutritionDeclarationEmbed, NutritionDeclarationEmbedBase, NutritionDeclarationEmbedNutrients, ProductCreate, ProductList, ProductOriginCreate, ProductRead, ProductState, ProductUpdate, RecipeCreate, RecipeIngredientCreate, RecipeIngredientEmbed, RecipeList, RecipeOriginCreate, RecipePreparationStepCreate, RecipePreparationStepEmbed, RecipeRead, RecipeState, RecipeUpdate, TaxonBagCreate, TaxonBagList, TaxonBagRead, TaxonBagUpdate, TaxonCreate, TaxonList, TaxonRead, TaxonUpdate, TaxonomyCreate, TaxonomyList, TaxonomyRead, TaxonomyUpdate, User, UserEmbed, UserGroup, UserGroupCreate, UserGroupList, UserGroupRead, UserGroupUpdate, UserList, UserRead, UserUpdate, VideoCreate, VideoCreateRead, VideoEmbed, VideoList, VideoOriginCreate, VideoRead, VideoState, VideoUpdate, VideoUpdateRead, ArticleApi, AttributeDefinitionApi, BrandApi, FileApi, ImageApi, IngredientApi, ProductApi, RecipeApi, TaxonomyApi, UserApi, VideoApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The AttributeDefinitionCreate model constructor.
     * @property {module:model/AttributeDefinitionCreate}
     */
    AttributeDefinitionCreate: AttributeDefinitionCreate,
    /**
     * The AttributeDefinitionList model constructor.
     * @property {module:model/AttributeDefinitionList}
     */
    AttributeDefinitionList: AttributeDefinitionList,
    /**
     * The AttributeDefinitionRead model constructor.
     * @property {module:model/AttributeDefinitionRead}
     */
    AttributeDefinitionRead: AttributeDefinitionRead,
    /**
    ...
    Metrics: Metrics,
    /**
     * The MetricsCreate model constructor.
     * @property {module:model/MetricsCreate}
     */
    MetricsCreate: MetricsCreate,
    /**
    ...
    UserGroup: UserGroup,
    /**
     * The UserGroupCreate model constructor.
     * @property {module:model/UserGroupCreate}
     */
    ...
    /**
     * The UserGroupRead model constructor.
     * @property {module:model/UserGroupRead}
     */
    UserGroupRead: UserGroupRead,
    /**
     * The UserGroupUpdate model constructor.
     * @property {module:model/UserGroupUpdate}
     */
    ...
    /**
     * The AttributeDefinitionApi service constructor.
     * @property {module:api/AttributeDefinitionApi}
     */
    AttributeDefinitionApi: AttributeDefinitionApi,
    /**
