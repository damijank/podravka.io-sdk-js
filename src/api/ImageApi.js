...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ImageCreate', 'model/ImageCreateRead', 'model/ImageList', 'model/ImageRead', 'model/ImageState', 'model/ImageUpdate', 'model/ImageUpdateRead'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ImageCreate'), require('../model/ImageCreateRead'), require('../model/ImageList'), require('../model/ImageRead'), require('../model/ImageState'), require('../model/ImageUpdate'), require('../model/ImageUpdateRead'));
  } else {
    // Browser globals (root is window)
    if (!root.Podravkaio) {
      root.Podravkaio = {};
    }
    root.Podravkaio.ImageApi = factory(root.Podravkaio.ApiClient, root.Podravkaio.ImageCreate, root.Podravkaio.ImageCreateRead, root.Podravkaio.ImageList, root.Podravkaio.ImageRead, root.Podravkaio.ImageState, root.Podravkaio.ImageUpdate, root.Podravkaio.ImageUpdateRead);
  }
}(this, function(ApiClient, ImageCreate, ImageCreateRead, ImageList, ImageRead, ImageState, ImageUpdate, ImageUpdateRead) {
  'use strict';
