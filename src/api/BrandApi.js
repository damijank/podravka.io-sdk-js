...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BrandCreate', 'model/BrandList', 'model/BrandRead', 'model/BrandState', 'model/BrandUpdate', 'model/Metrics'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BrandCreate'), require('../model/BrandList'), require('../model/BrandRead'), require('../model/BrandState'), require('../model/BrandUpdate'), require('../model/Metrics'));
  } else {
    // Browser globals (root is window)
    if (!root.Podravkaio) {
      root.Podravkaio = {};
    }
    root.Podravkaio.BrandApi = factory(root.Podravkaio.ApiClient, root.Podravkaio.BrandCreate, root.Podravkaio.BrandList, root.Podravkaio.BrandRead, root.Podravkaio.BrandState, root.Podravkaio.BrandUpdate, root.Podravkaio.Metrics);
  }
}(this, function(ApiClient, BrandCreate, BrandList, BrandRead, BrandState, BrandUpdate, Metrics) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the getBrandListMetrics operation.
     * @callback module:api/BrandApi~getBrandListMetricsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/BrandApi~getBrandListMetricsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Metrics>}
     */
    this.getBrandListMetrics = function(callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the getBrandMetrics operation.
     * @callback module:api/BrandApi~getBrandMetricsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.acceptLanguage Locale code
     * @param {module:api/BrandApi~getBrandMetricsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Metrics}
     */
    this.getBrandMetrics = function(id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getBrandMetrics");
      }
