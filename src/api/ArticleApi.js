...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ArticleCreate', 'model/ArticleList', 'model/ArticleRead', 'model/ArticleState', 'model/ArticleUpdate', 'model/Metrics'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ArticleCreate'), require('../model/ArticleList'), require('../model/ArticleRead'), require('../model/ArticleState'), require('../model/ArticleUpdate'), require('../model/Metrics'));
  } else {
    // Browser globals (root is window)
    if (!root.Podravkaio) {
      root.Podravkaio = {};
    }
    root.Podravkaio.ArticleApi = factory(root.Podravkaio.ApiClient, root.Podravkaio.ArticleCreate, root.Podravkaio.ArticleList, root.Podravkaio.ArticleRead, root.Podravkaio.ArticleState, root.Podravkaio.ArticleUpdate, root.Podravkaio.Metrics);
  }
}(this, function(ApiClient, ArticleCreate, ArticleList, ArticleRead, ArticleState, ArticleUpdate, Metrics) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the getArticleListMetrics operation.
     * @callback module:api/ArticleApi~getArticleListMetricsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.acceptLanguage Locale code
     * @param {module:api/ArticleApi~getArticleListMetricsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Metrics}
     */
    this.getArticleListMetrics = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the getArticleMetrics operation.
     * @callback module:api/ArticleApi~getArticleMetricsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Metrics} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.acceptLanguage Locale code
     * @param {module:api/ArticleApi~getArticleMetricsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Metrics}
     */
    this.getArticleMetrics = function(id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getArticleMetrics");
      }
