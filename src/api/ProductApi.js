...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Metrics', 'model/ProductCreate', 'model/ProductList', 'model/ProductRead', 'model/ProductState', 'model/ProductUpdate'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Metrics'), require('../model/ProductCreate'), require('../model/ProductList'), require('../model/ProductRead'), require('../model/ProductState'), require('../model/ProductUpdate'));
  } else {
    // Browser globals (root is window)
    if (!root.Podravkaio) {
      root.Podravkaio = {};
    }
    root.Podravkaio.ProductApi = factory(root.Podravkaio.ApiClient, root.Podravkaio.Metrics, root.Podravkaio.ProductCreate, root.Podravkaio.ProductList, root.Podravkaio.ProductRead, root.Podravkaio.ProductState, root.Podravkaio.ProductUpdate);
  }
}(this, function(ApiClient, Metrics, ProductCreate, ProductList, ProductRead, ProductState, ProductUpdate) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the getProductListMetrics operation.
     * @callback module:api/ProductApi~getProductListMetricsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.acceptLanguage Locale code
     * @param {module:api/ProductApi~getProductListMetricsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Metrics}
     */
    this.getProductListMetrics = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the getProductMetrics operation.
     * @callback module:api/ProductApi~getProductMetricsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Metrics} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.acceptLanguage Locale code
     * @param {module:api/ProductApi~getProductMetricsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Metrics}
     */
    this.getProductMetrics = function(id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getProductMetrics");
      }
