...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/RecipeCreate', 'model/RecipeList', 'model/RecipeRead', 'model/RecipeState', 'model/RecipeUpdate'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/RecipeCreate'), require('../model/RecipeList'), require('../model/RecipeRead'), require('../model/RecipeState'), require('../model/RecipeUpdate'));
  } else {
    // Browser globals (root is window)
    if (!root.Podravkaio) {
      root.Podravkaio = {};
    }
    root.Podravkaio.RecipeApi = factory(root.Podravkaio.ApiClient, root.Podravkaio.RecipeCreate, root.Podravkaio.RecipeList, root.Podravkaio.RecipeRead, root.Podravkaio.RecipeState, root.Podravkaio.RecipeUpdate);
  }
}(this, function(ApiClient, RecipeCreate, RecipeList, RecipeRead, RecipeState, RecipeUpdate) {
  'use strict';
