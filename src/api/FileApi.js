...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/FileCreate', 'model/FileCreateRead', 'model/FileList', 'model/FileRead', 'model/FileState', 'model/FileUpdate', 'model/FileUpdateRead', 'model/Metrics'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/FileCreate'), require('../model/FileCreateRead'), require('../model/FileList'), require('../model/FileRead'), require('../model/FileState'), require('../model/FileUpdate'), require('../model/FileUpdateRead'), require('../model/Metrics'));
  } else {
    // Browser globals (root is window)
    if (!root.Podravkaio) {
      root.Podravkaio = {};
    }
    root.Podravkaio.FileApi = factory(root.Podravkaio.ApiClient, root.Podravkaio.FileCreate, root.Podravkaio.FileCreateRead, root.Podravkaio.FileList, root.Podravkaio.FileRead, root.Podravkaio.FileState, root.Podravkaio.FileUpdate, root.Podravkaio.FileUpdateRead, root.Podravkaio.Metrics);
  }
}(this, function(ApiClient, FileCreate, FileCreateRead, FileList, FileRead, FileState, FileUpdate, FileUpdateRead, Metrics) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the getFileListMetrics operation.
     * @callback module:api/FileApi~getFileListMetricsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/Metrics>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Retrieves the metrics of File collection.
     * @param {module:api/FileApi~getFileListMetricsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Metrics>}
     */
    this.getFileListMetrics = function(callback) {
      var postBody = null;
    ...
    /**
     * Callback function to receive the result of the getFileMetrics operation.
     * @callback module:api/FileApi~getFileMetricsCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.acceptLanguage Locale code
     * @param {module:api/FileApi~getFileMetricsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Metrics}
     */
    this.getFileMetrics = function(id, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling getFileMetrics");
      }
