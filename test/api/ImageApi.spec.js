...
(function(root, factory) {
  ...
  describe('ImageApi', function() {
    ...
    describe('getImageListMetrics', function() {
      it('should call getImageListMetrics successfully', function(done) {
        //uncomment below and update the code to test getImageListMetrics
        //instance.getImageListMetrics(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getImageMetrics', function() {
      it('should call getImageMetrics successfully', function(done) {
        //uncomment below and update the code to test getImageMetrics
        //instance.getImageMetrics(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
