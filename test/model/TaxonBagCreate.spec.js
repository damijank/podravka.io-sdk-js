...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.TaxonBagCreate();
  });
  ...
  describe('TaxonBagCreate', function() {
    it('should create an instance of TaxonBagCreate', function() {
      // uncomment below and update the code to test TaxonBagCreate
      //var instance = new Podravkaio.TaxonBagCreate();
      //expect(instance).to.be.a(Podravkaio.TaxonBagCreate);
    });
