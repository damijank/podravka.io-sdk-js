...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.VideoCreateRead();
  });
  ...
  describe('VideoCreateRead', function() {
    it('should create an instance of VideoCreateRead', function() {
      // uncomment below and update the code to test VideoCreateRead
      //var instance = new Podravkaio.VideoCreateRead();
      //expect(instance).to.be.a(Podravkaio.VideoCreateRead);
    });
