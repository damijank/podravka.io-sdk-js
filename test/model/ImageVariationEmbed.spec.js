...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.ImageVariationEmbed();
  });
  ...
  describe('ImageVariationEmbed', function() {
    it('should create an instance of ImageVariationEmbed', function() {
      // uncomment below and update the code to test ImageVariationEmbed
      //var instance = new Podravkaio.ImageVariationEmbed();
      //expect(instance).to.be.a(Podravkaio.ImageVariationEmbed);
    });
