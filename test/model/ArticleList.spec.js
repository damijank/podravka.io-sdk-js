...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.ArticleList();
  });
  ...
  describe('ArticleList', function() {
    it('should create an instance of ArticleList', function() {
      // uncomment below and update the code to test ArticleList
      //var instance = new Podravkaio.ArticleList();
      //expect(instance).to.be.a(Podravkaio.ArticleList);
    });
