...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.FileCreateRead();
  });
  ...
  describe('FileCreateRead', function() {
    it('should create an instance of FileCreateRead', function() {
      // uncomment below and update the code to test FileCreateRead
      //var instance = new Podravkaio.FileCreateRead();
      //expect(instance).to.be.a(Podravkaio.FileCreateRead);
    });
