...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.ImageCreateRead();
  });
  ...
  describe('ImageCreateRead', function() {
    it('should create an instance of ImageCreateRead', function() {
      // uncomment below and update the code to test ImageCreateRead
      //var instance = new Podravkaio.ImageCreateRead();
      //expect(instance).to.be.a(Podravkaio.ImageCreateRead);
    });
