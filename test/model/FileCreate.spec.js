...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.FileCreate();
  });
  ...
  describe('FileCreate', function() {
    it('should create an instance of FileCreate', function() {
      // uncomment below and update the code to test FileCreate
      //var instance = new Podravkaio.FileCreate();
      //expect(instance).to.be.a(Podravkaio.FileCreate);
    });
