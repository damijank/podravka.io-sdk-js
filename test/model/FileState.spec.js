...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.FileState();
  });
  ...
  describe('FileState', function() {
    it('should create an instance of FileState', function() {
      // uncomment below and update the code to test FileState
      //var instance = new Podravkaio.FileState();
      //expect(instance).to.be.a(Podravkaio.FileState);
    });
