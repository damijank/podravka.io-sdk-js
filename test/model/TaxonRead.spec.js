...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.TaxonRead();
  });
  ...
  describe('TaxonRead', function() {
    it('should create an instance of TaxonRead', function() {
      // uncomment below and update the code to test TaxonRead
      //var instance = new Podravkaio.TaxonRead();
      //expect(instance).to.be.a(Podravkaio.TaxonRead);
    });
