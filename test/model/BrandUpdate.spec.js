...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.BrandUpdate();
  });
  ...
  describe('BrandUpdate', function() {
    it('should create an instance of BrandUpdate', function() {
      // uncomment below and update the code to test BrandUpdate
      //var instance = new Podravkaio.BrandUpdate();
      //expect(instance).to.be.a(Podravkaio.BrandUpdate);
    });
