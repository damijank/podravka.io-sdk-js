...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.VideoState();
  });
  ...
  describe('VideoState', function() {
    it('should create an instance of VideoState', function() {
      // uncomment below and update the code to test VideoState
      //var instance = new Podravkaio.VideoState();
      //expect(instance).to.be.a(Podravkaio.VideoState);
    });
