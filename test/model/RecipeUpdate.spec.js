...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.RecipeUpdate();
  });
  ...
  describe('RecipeUpdate', function() {
    it('should create an instance of RecipeUpdate', function() {
      // uncomment below and update the code to test RecipeUpdate
      //var instance = new Podravkaio.RecipeUpdate();
      //expect(instance).to.be.a(Podravkaio.RecipeUpdate);
    });
