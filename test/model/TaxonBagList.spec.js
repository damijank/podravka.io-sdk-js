...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.TaxonBagList();
  });
  ...
  describe('TaxonBagList', function() {
    it('should create an instance of TaxonBagList', function() {
      // uncomment below and update the code to test TaxonBagList
      //var instance = new Podravkaio.TaxonBagList();
      //expect(instance).to.be.a(Podravkaio.TaxonBagList);
    });
