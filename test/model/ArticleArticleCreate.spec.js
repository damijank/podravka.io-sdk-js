...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.ArticleArticleCreate();
  });
  ...
  describe('ArticleArticleCreate', function() {
    it('should create an instance of ArticleArticleCreate', function() {
      // uncomment below and update the code to test ArticleArticleCreate
      //var instane = new Podravkaio.ArticleArticleCreate();
      //expect(instance).to.be.a(Podravkaio.ArticleArticleCreate);
    });
