...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.FileUpdateRead();
  });
  ...
  describe('FileUpdateRead', function() {
    it('should create an instance of FileUpdateRead', function() {
      // uncomment below and update the code to test FileUpdateRead
      //var instance = new Podravkaio.FileUpdateRead();
      //expect(instance).to.be.a(Podravkaio.FileUpdateRead);
    });
