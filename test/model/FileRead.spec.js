...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.FileRead();
  });
  ...
  describe('FileRead', function() {
    it('should create an instance of FileRead', function() {
      // uncomment below and update the code to test FileRead
      //var instance = new Podravkaio.FileRead();
      //expect(instance).to.be.a(Podravkaio.FileRead);
    });
