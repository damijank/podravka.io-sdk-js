...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.ImageUpdateRead();
  });
  ...
  describe('ImageUpdateRead', function() {
    it('should create an instance of ImageUpdateRead', function() {
      // uncomment below and update the code to test ImageUpdateRead
      //var instance = new Podravkaio.ImageUpdateRead();
      //expect(instance).to.be.a(Podravkaio.ImageUpdateRead);
    });
