...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.ArticleArticleCreateReadCreateReadArticleReadRead();
  });
  ...
  describe('ArticleArticleCreateReadCreateReadArticleReadRead', function() {
    it('should create an instance of ArticleArticleCreateReadCreateReadArticleReadRead', function() {
      // uncomment below and update the code to test ArticleArticleCreateReadCreateReadArticleReadRead
      //var instane = new Podravkaio.ArticleArticleCreateReadCreateReadArticleReadRead();
      //expect(instance).to.be.a(Podravkaio.ArticleArticleCreateReadCreateReadArticleReadRead);
    });
