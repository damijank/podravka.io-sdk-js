...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.TaxonBagRead();
  });
  ...
  describe('TaxonBagRead', function() {
    it('should create an instance of TaxonBagRead', function() {
      // uncomment below and update the code to test TaxonBagRead
      //var instance = new Podravkaio.TaxonBagRead();
      //expect(instance).to.be.a(Podravkaio.TaxonBagRead);
    });
