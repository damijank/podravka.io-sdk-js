...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Podravkaio.ArticleArticleUpdateReadUpdateReadArticleReadRead();
  });
  ...
  describe('ArticleArticleUpdateReadUpdateReadArticleReadRead', function() {
    it('should create an instance of ArticleArticleUpdateReadUpdateReadArticleReadRead', function() {
      // uncomment below and update the code to test ArticleArticleUpdateReadUpdateReadArticleReadRead
      //var instane = new Podravkaio.ArticleArticleUpdateReadUpdateReadArticleReadRead();
      //expect(instance).to.be.a(Podravkaio.ArticleArticleUpdateReadUpdateReadArticleReadRead);
    });
